(() => {
  ...
  function fullAnalystReportMarkup(records){
    ...
    return `<div class="full-analyst-report">
      ${analystNarrativeMarkup(records)}
  ...
  function renderAdminReports(){
    ...
    const summaryContent=`
      <div class="bi-kpi-grid analyst-kpi-grid">
        ...
        ${can("reports.financial")?reportKpiCard("Verified collected",formatMoney(k.verified),`${k.collectionRate}% of expected active fees`):""}
        ${reportKpiCard("DUPR coverage",`${k.duprCoverage}%`,"Known players with a usable DUPR rating")}
        ${reportKpiCard("Needs attention",k.needsReview.toLocaleString("en-PH"),"Eligibility, approval, or payment follow-up")}
      </div>
      ${analystNarrativeMarkup(records)}
      ${analystPriorityMarkup(records)}
      ${analystSummaryVisuals(records)}
