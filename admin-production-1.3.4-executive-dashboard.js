(() => {
  ...
  function reportDefinition(key,records){
    ...
    if(key==="financial"){
      ...
      return {
        ...
        tableHeaders:["Financial metric","Amount","Director interpretation"],
        tableRows:[
  ...
  function executiveAnalystPanel(records){
    ...
    return `<aside class="executive-analyst-card">
      <div class="executive-section-head compact"><div><h3>Senior Analyst Interpretation</h3><p>What requires management attention now</p></div></div>
  ...
  // =========================================================
  // SENIOR ANALYST REPORTING LAYER
  ...
  function analystNarrativeMarkup(records){
    ...
    return `<section class="analyst-narrative-card">
      <div class="analyst-narrative-head"><div><span class="eyebrow">Senior analyst interpretation</span><h3>What the numbers are saying</h3></div><span class="analyst-scope-chip">${esc(scope)} in scope</span></div>
  ...
  function analystVisualCard(key,records,type=null,options={}){
    ...
    return `<article class="analyst-visual-card ${options.wide?"wide":""}">
      ...
      <div class="analyst-explanation"><span>Analyst interpretation</span><p>${esc(analystInterpretation(key,records))}</p></div>
  ...
  function reportViewToggleMarkup(){
    return `<div class="report-view-toggle" role="tablist" aria-label="Reports view">
      <button type="button" class="${reportViewMode==="summary"?"active":""}" data-report-view="summary" role="tab" aria-selected="${reportViewMode==="summary"}"><span>Summary</span><small>Director overview & priorities</small></button>
      <button type="button" class="${reportViewMode==="full"?"active":""}" data-report-view="full" role="tab" aria-selected="${reportViewMode==="full"}"><span>Full Report</span><small>Complete analysis, charts & tables</small></button>
    </div>`;
  }
  ...
  function renderAdminReports(){
    ...
    const overviewKpis=`
      <div class="executive-kpi-grid" aria-label="Tournament report summary metrics">
        ${executiveKpiCard("Total Registrations",k.registrations.toLocaleString("en-PH"),"Current filtered scope","green","●")}
    ...
    const summaryContent=`
      ...
      ${analystActionTable(records)}
      ${directorReportCenterMarkup(records)}
    `;
        ...
        <section class="bi-explorer">
          <div class="bi-explorer-top">
            <div>
              ...
              <p>Use this for ad-hoc analysis beyond the recommended Director report. The chart and table respond to the same page filters.</p>
            </div>
          ...
          <div class="bi-visual-card">
            ...
            <div class="analyst-explanation explorer-explanation"><span>Analyst interpretation</span><p>${esc(analystInterpretation(reportKey,records))}</p></div>
          </div>
    ...
    return `<div class="bi-page analyst-report-page">
      <div class="admin-panel-heading bi-heading">
        <div>
          ...
          <p>A Director-level analytical workspace: executive summary for fast decisions and a complete report for detailed review, reconciliation, and tournament readiness.</p>
        </div>
      ...
      <section class="dashboard-filter-section analyst-filter-section">
        <div class="dashboard-filter-head">
          <div><span class="eyebrow">Analysis scope</span><h3>Filter the report</h3><p>Every KPI, chart, explanation, and table below uses the same selected scope.</p></div>
