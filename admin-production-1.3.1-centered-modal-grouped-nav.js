    ...
    return `<div class="bi-page">
      <div class="admin-panel-heading bi-heading">
        <div>
          ...
          <h2>Tournament Director Reports</h2>
          <p>Registration, capacity, finance, player, action, roster, audit, and notification reporting in one operational workspace.</p>
        </div>
      ...
      ${directorExecutiveSummaryMarkup(records)}
