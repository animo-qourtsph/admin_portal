(() => {
  ...
  function registrationListRow(r){
    ...
    const verification=eligibility.higherLevelApplied
  ...
  function fullAnalystReportMarkup(records){
    ...
    sections.push(fullReportModule(
      "3. Eligibility, Fairness & Classification",
    ...
    if(can("reports.financial"))sections.push(fullReportModule(
      "4. Financial Performance & Reconciliation",
    ...
    sections.push(fullReportModule(
      `${can("reports.financial")?"5":"4"}. Player Profile & Participation`,
    ...
    sections.push(fullReportModule(
      `${can("reports.financial")?"6":"5"}. Tournament Readiness & Production`,
